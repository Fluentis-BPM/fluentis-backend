...
namespace FluentisCore.Migrations
{
    ...
    [Migration("20250807175945_PasosSolicitudMigration")]
    partial class PasosSolicitudMigration
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FluentisCore.Models.InputAndApprovalManagement.RelacionUsuarioGrupo", b =>
                {
                    ...
                    b.Property<int?>("GrupoAprobacionIdGrupo")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("GrupoAprobacionIdGrupo");
            ...
            modelBuilder.Entity("FluentisCore.Models.InputAndApprovalManagement.RelacionUsuarioGrupo", b =>
                {
                    ...
                    b.HasOne("FluentisCore.Models.InputAndApprovalManagement.GrupoAprobacion", null)
                        .WithMany("RelacionesUsuarioGrupo")
                        .HasForeignKey("GrupoAprobacionIdGrupo");
